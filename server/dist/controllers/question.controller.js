...
const run = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (let i = 0; i < visibleTestCases.length; i++) {
            ...
            // Compilation Error 
            if ((_a = response.data.compile) === null || _a === void 0 ? void 0 : _a.stderr) {
                return res.status(200).json({
                    success: false,
                    status: "WA",
...
exports.run = run;
const submitCode = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
...
const getAllQuestions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const allQuestions = yield question_model_1.questionModel.find();
...
const totalQuestion = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalQuestion = yield question_model_1.questionModel.find();
...
exports.totalQuestion = totalQuestion;
